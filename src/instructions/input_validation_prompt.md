...
## Your Task
Analyze the conversation context (last few messages) and determine if the latest user message is appropriate.
...
- When in doubt about borderline cases related to Seppe's work, allow them
