...
export function ContactForm(_props: ContactFormProps) {
  ...
  const isFormValid =
    name.trim() && email.trim() && message.trim() && message.length <= 1000;
      ...
      <form onSubmit={handleSubmit} className="space-y-[16px]">
        ...
        <div className="space-y-[8px]">
          <label
            ...
            className="block text-[14px] font-medium text-[#FAFAFA]"
          >
        ...
        <div className="space-y-[8px]">
          <div className="flex justify-between items-center">
            ...
            <span
              className={`text-[12px] ${message.length > 1000 ? "text-[#EF4444]" : "text-[#6B7280]"}`}
            >
              {message.length}/1000
            </span>
          </div>
        ...
        {submitStatus === "error" && (
          <div className="flex items-start gap-[8px] bg-[#FEF2F2] border border-[#FCA5A5] rounded-[8px] p-[12px]">
            <AlertCircle
              size={16}
              className="text-[#DC2626] mt-[2px] shrink-0"
            />
        ...
        {submitStatus === "success" && (
          <div className="flex items-start gap-[8px] bg-[#F0FDF4] border border-[#86EFAC] rounded-[8px] p-[12px]">
            <CheckCircle
              size={16}
              className="text-[#16A34A] mt-[2px] shrink-0"
            />
